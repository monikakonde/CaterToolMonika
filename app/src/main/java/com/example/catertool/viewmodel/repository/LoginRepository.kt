...
class LoginRepository(private val endpoints: ApiClient) {
    val TAG = javaClass.simpleName

    // var endpoints: ApiClient = ApiClient()
    fun doLogin(identifierNo: String, otp: String): MutableLiveData<Login> {
        ...
        val request: Map<String, String> = RetrofitRequest.loginRequest(identifierNo, otp)

        val call: Call<Login> = apiService.loginRequest(request)
